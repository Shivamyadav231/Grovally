    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-6">
      ...
      >
        ...
        <input
          ...
          className="w-full mt-6 px-4 py-3  text-black border rounded-xl outline-none"
          required
        />
        ...
        <input
          ...
          className="w-full mt-4 px-4 text-black py-3 border rounded-xl outline-none"
          required
        />
