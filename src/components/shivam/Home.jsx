...
`,
    ...
    Image:
      "https://res.cloudinary.com/dzu9qjxqa/image/upload/f_auto,q_auto,w_800/v1781770387/Aaa_k7fq9t.png",
    link: "/it",
  },
  {
...
Business Valuation & Investment Advisory`,
    ...
    Image:
      "https://res.cloudinary.com/dzu9qjxqa/image/upload/f_auto,q_auto,w_800/v1781770410/Sss_sduj87.png",
    link: "/business",
  },
  {
    description: ` Government Tender Consultancy,
...
Private Tender Assistance,
 ...
 Tender Compliance & Contract Support`,
    ...
    Image:
      "https://res.cloudinary.com/dzu9qjxqa/image/upload/f_auto,q_auto,w_800/v1781770387/BBB_ddpa51.png",
    link: "/tender",
  },
  {
...
`,
    ...
    Image:
      "https://res.cloudinary.com/dzu9qjxqa/image/upload/f_auto,q_auto,w_800/v1781770395/KKK_ltrp7q.png",
    link: "/acadamy",
  },
];
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-14 sm:px-6 sm:py-20">
        ...
        >
          ...
          <div className="flex flex-col items-center -mt-28 sm:items-start text-center sm:text-left gap-6">
            <img
              loading="lazy"
              src="https://res.cloudinary.com/dzu9qjxqa/image/upload/f_auto,q_auto,w_600/v1781770397/lolo_t6dwpa.png"
              decoding="async"
              alt="logo"
              className="w-full max-w-[22rem] object-contain"
            />
          ...
          <p className="mt-8 max-w-3xl text-base leading-8 text-gray-700 sm:text-lg">
            Grovally is your trusted partner for digital growth. We provide
            website development, software solutions, digital marketing,
            branding, AI services, business registration, trademark support,
            and business consulting under one roof. Our goal is to help
            startups, businesses, and organizations grow faster with
            reliable, affordable, and result-driven solutions.
          </p>
